...
RSpec.describe User do
  ...
  describe '.get_meals' do
    it "gets meals for a specific date" do
    ...
    it "orders by time of day" do
      user = User.create!(name: "Rowan", email: "rowan@test.com", access_token: '12345')
      user2 = User.create!(name: "Jamie", email: "jamie@test.com", access_token: '23456')

      meal1 = user.meals.create!(name: "Lunch", meal_time: '2021-11-06T012:30:00+00:00')
      meal2 = user.meals.create!(name: "Breakfast", meal_time: '2021-11-06T08:30:00+00:00')
      meal3 = user.meals.create!(name: "Lunch", meal_time: '2021-11-07T012:30:00+00:00')
      ...
      expect(user.get_meals('2021-11-06T08:30:00+00:00')).to eq([meal2, meal1])
    end
  end
end
